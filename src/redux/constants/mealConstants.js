...
export const MEAL_UPDATE_FOOD_DELETE_REQUEST =
  'MEAL_UPDATE_FOOD_DELETE_REQUEST';
export const MEAL_UPDATE_FOOD_DELETE_SUCCESS =
  'MEAL_UPDATE_FOOD_DELETE_SUCCESS';
export const MEAL_UPDATE_FOOD_DELETE_FAIL = 'MEAL_UPDATE_FOOD_DELETE_FAIL';
